    ...
    <div class="login">
      <div class="login-center">
        <div class="form-section">
          <div class="form-item">
            <input placeholder="输入您的账号" class="item-input" type="text" @focus="onFocus" :class="[isShow ? 'active' : '']" v-model="userName" />
        ...
        <Message @onClose="onClose" :isConfirm="isConfirm" @onLogin="onLogin" />
      </div>
    </div>
  </div>
</template>
